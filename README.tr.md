...
| **Derin paket anketi** | **`statistics.deep_survey`**: yakalama süresi, port/DNS/HTTP özetleri, TLS tahminleri, **`cleartext_hints`**, **`ics_port_visibility`**, banner örnekleri, zaman çizelgesi ve **OT şifresiz veri** sezgisel tespitleri (aşağıdaki bölüm). |
